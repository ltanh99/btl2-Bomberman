...
public class Sprite {
	...
	|--------------------------------------------------------------------------
	 */
	public static Sprite grass = new Sprite(16, 8, 1, SpriteSheet.tiles, 16, 16);
	...
	public static Sprite wall = new Sprite(16, 5, 0, SpriteSheet.tiles, 16, 16);
        public static Sprite _wall = new Sprite(16, 12, 10, SpriteSheet.tiles, 16, 16);
	...
	|--------------------------------------------------------------------------
	 */
	public static Sprite player2_up = new Sprite(16, 0, 12, SpriteSheet.tiles, 12, 16);
	public static Sprite player2_down = new Sprite(16, 2, 12, SpriteSheet.tiles, 12, 15);
	public static Sprite player2_left = new Sprite(16, 3, 12, SpriteSheet.tiles, 10, 15);
	public static Sprite player2_right = new Sprite(16, 1, 12, SpriteSheet.tiles, 10, 16);
	
	public static Sprite player2_up_1 = new Sprite(16, 0, 13, SpriteSheet.tiles, 12, 16);
	public static Sprite player2_up_2 = new Sprite(16, 0, 14, SpriteSheet.tiles, 12, 15);
	
	public static Sprite player2_down_1 = new Sprite(16, 2, 13, SpriteSheet.tiles, 12, 15);
	public static Sprite player2_down_2 = new Sprite(16, 2, 14, SpriteSheet.tiles, 12, 16);
	
	public static Sprite player2_left_1 = new Sprite(16, 3, 13, SpriteSheet.tiles, 11, 16);
	public static Sprite player2_left_2 = new Sprite(16, 3, 14, SpriteSheet.tiles, 12 ,16);
	
	public static Sprite player2_right_1 = new Sprite(16, 1, 13, SpriteSheet.tiles, 11, 16);
	public static Sprite player2_right_2 = new Sprite(16, 1, 14, SpriteSheet.tiles, 12, 16);
	
	public static Sprite player2_dead1 = new Sprite(16, 4, 14, SpriteSheet.tiles, 14, 16);
	public static Sprite player2_dead2 = new Sprite(16, 5, 14, SpriteSheet.tiles, 13, 15);
	public static Sprite player2_dead3 = new Sprite(16, 6, 14, SpriteSheet.tiles, 16, 16);
	...
	public static Sprite ovape_dead = new Sprite(16, 6, 8, SpriteSheet.tiles, 16, 16);
        ...
        //Pontan1
        public static Sprite pontan1_left1 = new Sprite(16, 12, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite pontan1_left2 = new Sprite(16, 12, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite pontan1_left3 = new Sprite(16, 12, 7, SpriteSheet.tiles, 16, 16);
	
	public static Sprite pontan1_right1 = new Sprite(16, 13, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite pontan1_right2 = new Sprite(16, 13, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite pontan1_right3 = new Sprite(16, 13, 7, SpriteSheet.tiles, 16, 16);
	
	public static Sprite pontan1_dead = new Sprite(16, 12, 8, SpriteSheet.tiles, 16, 16);
	
        //Pontan2
        public static Sprite pontan2_left1 = new Sprite(16, 14, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite pontan2_left2 = new Sprite(16, 14, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite pontan2_left3 = new Sprite(16, 14, 7, SpriteSheet.tiles, 16, 16);
	
	public static Sprite pontan2_right1 = new Sprite(16, 15, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite pontan2_right2 = new Sprite(16, 15, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite pontan2_right3 = new Sprite(16, 15, 7, SpriteSheet.tiles, 16, 16);
	
	public static Sprite pontan2_dead = new Sprite(16, 14, 8, SpriteSheet.tiles, 16, 16);
	...
	|--------------------------------------------------------------------------
	 */
	public static Sprite powerup_bombs = new Sprite(16, 8, 2, SpriteSheet.tiles, 16, 16);
	public static Sprite powerup_flames = new Sprite(16, 8, 10, SpriteSheet.tiles, 16, 16);
	public static Sprite powerup_speed = new Sprite(16, 8, 3, SpriteSheet.tiles, 16, 16);
	public static Sprite powerup_wallpass = new Sprite(16, 9, 10, SpriteSheet.tiles, 16, 16);
	public static Sprite powerup_detonator = new Sprite(16, 4, 10, SpriteSheet.tiles, 16, 16);
	public static Sprite powerup_bombpass = new Sprite(16, 12, 10, SpriteSheet.tiles, 16, 16);
	public static Sprite powerup_flamepass = new Sprite(16, 10, 10, SpriteSheet.tiles, 16, 16);
	public static Sprite powerup_random = new Sprite(16, 11, 10, SpriteSheet.tiles,16,16);
